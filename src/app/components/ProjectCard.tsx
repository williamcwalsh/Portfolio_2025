...
export default function ProjectCard({ id, title, description, description2, imageSrc, fromLeft }: ProjectCardProps) {
    ...
    return (
        ...
        >
            ...
            {description2 && (
                <p className="text-base font-bold text-gray-700 text-left">{description2}</p>
            )}
        </motion.div>
